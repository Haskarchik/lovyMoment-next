/**
 * EN "About us" page (`/en/about-us`). Server component — content is the
 * English copy of the marketing page. Metadata is fully translated.
 */
          ...
          <div className={aboutUsStyles.experience_content}>
            <div className={aboutUsStyles.experience_text}>
              ...
              <div className={aboutUsStyles.experience_item}>
                ...
                <p>who keep coming back and recommending us.</p>
              </div>
              <div className={aboutUsStyles.experience_item}>
          ...
          <div className={aboutUsStyles.contact_content}>
            <div className={aboutUsStyles.contact_info}>
              ...
              <div className={aboutUsStyles.phones}>
                <a href="tel:+380979371691" className={aboutUsStyles.phone_link}>+38 (097) 937 16 91</a>
                <a href="tel:+380638604966" className={aboutUsStyles.phone_link}>+38 (063) 860 49 66</a>
              </div>
              ...
              <div className={aboutUsStyles.messengers}>
                ...
                <div className={aboutUsStyles.messenger_links}>
                  <a href="https://wa.me/380979371691" className={aboutUsStyles.messenger_link} rel="noopener noreferrer" target="_blank">WhatsApp</a>
                  <a href="viber://add?number=380979371691" className={aboutUsStyles.messenger_link}>Viber</a>
                  <a href="https://t.me/pavluyk" className={aboutUsStyles.messenger_link} rel="noopener noreferrer" target="_blank">Telegram</a>
                  <a href="https://www.instagram.com/lovymomentlviv/" className={aboutUsStyles.messenger_link} rel="noopener noreferrer" target="_blank">Instagram</a>
                </div>
              </div>
            </div>
